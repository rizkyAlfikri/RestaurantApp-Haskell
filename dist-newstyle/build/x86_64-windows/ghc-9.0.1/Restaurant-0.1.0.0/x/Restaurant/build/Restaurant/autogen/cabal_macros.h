...
/* package Restaurant-0.1.0.0 */
#ifndef VERSION_Restaurant
#define VERSION_Restaurant "0.1.0.0"
#endif /* VERSION_Restaurant */
#ifndef MIN_VERSION_Restaurant
#define MIN_VERSION_Restaurant(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Restaurant */
...
#define CURRENT_COMPONENT_ID "Restaurant-0.1.0.0-inplace-Restaurant"
